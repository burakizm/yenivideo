...
💡 **Bu bot hakkında takip eden bir sorunuz varsa, bunu buradaki destek sohbetimde iletebilirsiniz.**
...
async def cbsudo(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""🏮
Üzgünüm bu komutları sadece bot sahibi kullanabilir sen de kendine ait bir bot istiyorsan sahip 'e yazabilirsin...
